            ...
            <div className="mx-auto w-full max-w-[1600px] px-4 sm:px-6">
                <div className="flex flex-col gap-3 items-center mt-16 w-full">
                    <div className="relative w-full">
                        <h3 className="text-center text-3xl sm:text-5xl font-bold mb-1 leading-tight flex items-center gap-3 justify-center">
                        ...
                        {seeAllHref && (
                            <Link
                                href={seeAllHref}
                                className="hidden sm:inline-flex absolute right-0 top-1/2 -translate-y-1/2 text-teal-600 font-semibold hover:text-teal-800 transition text-lg"
                            >
                                See all
                            </Link>
                        )}
