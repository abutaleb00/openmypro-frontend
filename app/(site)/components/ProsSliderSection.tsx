            ...
            <div className="mx-auto w-full max-w-[1600px] px-4 sm:px-6">
                <div className="flex flex-col gap-3 items-center mt-16 w-full">
                    <div className="relative w-full flex justify-center items-center">
                        <h3 className="text-3xl sm:text-5xl font-bold mb-1 leading-tight flex items-center gap-3">
                        ...
                        {seeAllHref && (
                            <Link
                                href={seeAllHref}
                                className="absolute right-4 top-1/2 -translate-y-1/2 text-teal-600 font-semibold hover:text-teal-800 transition text-xl"
                            >
                                See all
                            </Link>
                        )}
                    ...
                    <div
                        className={tw(
                            'w-40 h-1 mx-auto rounded-full bg-gradient-to-r',
                            theme.underlineFrom,
                            theme.underlineTo
                        )}
                    />
                ...
                <div className="relative mx-auto w-full">
                    <button
                        id={navPrev}
                        aria-label="Previous"
                        className="hidden sm:flex border border-gray-300 absolute top-1/2 -left-6 w-[42px] p-2 transform -translate-y-1/2 cursor-pointer bg-white/90 hover:bg-white shadow-xl rounded-full text-gray-800 hover:text-teal-600 transition-colors z-20 hover:border-teal-600"
                    >
                    ...
                    <button
                        id={navNext}
                        aria-label="Next"
                        className="hidden sm:flex border border-gray-300 absolute top-1/2 -right-6 w-[42px] p-2 transform -translate-y-1/2 cursor-pointer bg-white/90 hover:bg-white shadow-xl rounded-full text-gray-800 hover:text-teal-600 transition-colors z-20 hover:border-teal-600"
                    >
                        <svg width="24" height="24" viewBox="0 0 24 24">
                            ...
                            {p.city && (
                                <p className="text-xs sm:text-sm flex items-center pt-1 text-white">
                                    <svg
                                        ...
                                        height="16"
                                        viewBox="0 0 24 24"
                                        className="mr-1 min-w-[16px] text-white"
                                        fill="none"
                                        stroke="currentColor"
                                        strokeWidth="2"
                                    >
